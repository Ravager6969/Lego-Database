...
while True and __name__ == '__main__':
    ...
    #text box in main menu
    patchnotes = open('Updates.txt', 'r')
    patchnotes_read = patchnotes.read()
    patchnotes.close()
    patchnotes_display = ravager(str(patchnotes), pygame.Rect(900,900, 200, 200), font, sky_blue, gold, scrollvalue=30, )
    patchnotes_display.display()
    #if controls == True and main_menu == False and options == False:
