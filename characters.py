...
clubskills={
    ...
    "Mining Club":("This club gathers resources, mainly ores for the village. Higher-ranked members in this club also repair, create, and maintain residences. Currently recruiting all hard-working miners, regardless of gear.","Skill Bonus for members: +2 Mining"),
    "Warriors Club":("The most competitive club in the village. Members work together to defend the village from any threats or a wild, erratic, and misbehaving Golem. New recruits must fight low-ranked members in weekly events to secure a spot in the club.","Skill Bonus for members: +2 Combat"),
    ...
    "Goon Squad":("Camping by the Desert Outpost, this club is perfect for new characters beginning their Minecraft journey. The only requirements to join this club are a greedy mind and a Combat skill of 2 or lower. You must be voted in by a majority of the members.","Skill Bonus for members: +1 Mining, +1 Crafting"),
    ...
    "Villains Club":("This club spends most of their time upgrading weapons, coming up with malicious plans, and preparing their forces. Occasionally, they launch massive attacks, capable of wiping out the entire village. To apply, one must have at least 69 Golem kills and the ability to tame a Ravager.","Skill Bonus for members: +1 Combat, +1 Mining"),
}
